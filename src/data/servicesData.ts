...
export const services: Service[] = [
  // Academic Writing Services (15)
  {
    ...
    metaDescription: "Get A+ quality, plagiarism-free essays written by expert writers. Affordable Prices, on-time delivery, and unlimited revisions for student success.",
    price: "$15",
  ...
  },
  {
    ...
    metaDescription: "Need a custom research paper? Our experts deliver original, cited, and in-depth papers for any subject. Get a quote today!",
    price: "$20",
  ...
  },
  {
    ...
    metaDescription: "Struggling with your thesis? Our specialist writers provide chapter-by-chapter support for literature review, methodology, analysis, and more.",
    price: "$150",
  ...
  },
  {
    ...
    metaDescription: "Doctoral dissertation writing help from seasoned academics. Get support for every chapter, from introduction to conclusion.",
    price: "$200",
  ...
  },
  {
    ...
    description: "Complete support for all types of coursework, from problem sets to reports.",
    metaDescription: "Overwhelmed with assignments? We provide help with all types of coursework, from problem sets to reports. Timely and reliable.",
    price: "$10",
  ...
  },
  {
    ...
    metaDescription: "Impress with professionally written business, technical, or academic reports. Clear, concise, and structured for impact.",
    price: "$20",
