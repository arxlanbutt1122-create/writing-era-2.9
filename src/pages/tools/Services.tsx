  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        ...
        description="Explore WritingEra writing services for essays, dissertations, reports, editing, business plans, resumes, and more across multiple categories."
        path="/services"
        keywords={["writing services", "essay writing service", "dissertation writing", "business writing", "editing services"]}
        schema={webpageSchema({ title: "Writing Services | WritingEra", description: "Explore WritingEra writing services for essays, dissertations, reports, editing, business plans, resumes, and more across multiple categories.", url: "https://www.writingera.com/services" })}
      />
      <Navigation />
